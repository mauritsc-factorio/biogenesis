...
data:extend({
  ...
  -------------------------------------------------------------------------------
  {
    ...
    effects = {},  -- Highlighting is handled in control.lua
    unit = free_unit(1),
    order = "a-a",
  },
  ...
  -------------------------------------------------------------------------------
  {
    ...
    effects = {
      ...
      {type = "unlock-recipe", recipe = "bio-era1-bark-scraper"},
      {type = "unlock-recipe", recipe = "bio-era1-digging-stick"},
      {type = "unlock-recipe", recipe = "bio-era1-bark-strip"},
      {type = "unlock-recipe", recipe = "bio-era1-scrape-fungus"},
    },
    prerequisites = {"bio-era1-foragers-eye"},
    unit = free_unit(10),
    order = "a-b",
  },
  ...
  -------------------------------------------------------------------------------
  {
    ...
    effects = {
      {type = "unlock-recipe", recipe = "bio-era1-fiber-cord"},
      {type = "unlock-recipe", recipe = "bio-era1-leaching-basket-recipe"},
      {type = "unlock-recipe", recipe = "bio-era1-drying-rack-recipe"},
      {type = "unlock-recipe", recipe = "bio-era1-pestle"},
      {type = "unlock-recipe", recipe = "bio-era1-leach-nuts"},
      {type = "unlock-recipe", recipe = "bio-era1-dry-fungus"},
    },
    prerequisites = {"bio-era1-material-properties"},
    unit = free_unit(15),
    order = "a-c",
  },
  ...
  -------------------------------------------------------------------------------
  {
    ...
    effects = {
      ...
      {type = "unlock-recipe", recipe = "bio-era1-root-porridge"},
      {type = "unlock-recipe", recipe = "bio-era1-starch-porridge"},
      {type = "unlock-recipe", recipe = "bio-era1-fungus-broth"},
      {type = "unlock-recipe", recipe = "bio-era1-nut-cake"},
      {type = "unlock-recipe", recipe = "bio-era1-trail-mix"},
    },
    prerequisites = {"bio-era1-material-properties"},
    unit = free_unit(10),
    order = "a-d",
  ...
  -------------------------------------------------------------------------------
  {
    ...
    effects = {
      {type = "unlock-recipe", recipe = "bio-era1-compost-heap-recipe"},
      {type = "unlock-recipe", recipe = "bio-era1-compost-load"},
      {type = "unlock-recipe", recipe = "bio-era1-compost-mature"},
      {type = "unlock-recipe", recipe = "bio-era1-waste-chaff"},
      {type = "unlock-recipe", recipe = "bio-era1-clover-mulch"},
      {type = "unlock-recipe", recipe = "bio-era1-waste-clover-mulch"},
      {type = "unlock-recipe", recipe = "bio-era1-waste-shell"},
      {type = "unlock-recipe", recipe = "bio-era1-waste-bark"},
      {type = "unlock-recipe", recipe = "bio-era1-waste-peat"},
      {type = "unlock-recipe", recipe = "bio-era1-waste-grass"},
      {type = "unlock-recipe", recipe = "bio-era1-observational-analysis-kit"},
    },
    prerequisites = {"bio-era1-fiber-arts", "bio-era1-thermal-processing"},
    unit = free_unit(20),
    order = "a-e",
  },
  ...
  -------------------------------------------------------------------------------
  {
    ...
    prerequisites = {"bio-era1-decomposition-basics"},
    unit = oak_unit(2, 15),
    order = "a-f",
  },
